...
from backend_request_func_timestamp import (
    ASYNC_REQUEST_FUNCS,
...
async def benchmark(
    ...
    if args.save_output:
        print("*" * 20)
        result_path = save_test_outputs(outputs, out_path=args.out_path)
        print("Saved result path:", result_path)
    if profile:
    ...
    result = {
        ...
        "send_timestamps_ms": [output.send_timestamp_ms for output in outputs],
    }
