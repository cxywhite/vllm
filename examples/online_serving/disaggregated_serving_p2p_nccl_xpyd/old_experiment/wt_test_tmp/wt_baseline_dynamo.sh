...
REPRODUCE_BASELINE_CSV_PATH=${REPRODUCE_BASELINE_CSV_PATH:-"/root/predict-schedule/vllm/examples/online_serving/disaggregated_serving_p2p_nccl_xpyd/experiment_result/experiment_paper/tmp/baseline_119/benchmark_np1000_rr4_mt8192_20260119_150213_2p4d/dataset_result/test_results_20260119_151551.csv"}
...
# 日志与输出目录
BASE_RESULT_DIR=${BASE_RESULT_DIR:-./experiment_result/experiment_paper/tmp/baseline_dynamo_123_2p4d}
