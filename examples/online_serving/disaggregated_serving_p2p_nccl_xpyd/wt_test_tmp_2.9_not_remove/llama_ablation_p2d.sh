...
USE_CUSTOM_PROXY="true"  # 是否使用自定义的proxy脚本
USE_AIMD_SCHEDULER="true"
TEST_ABLATION_P2D="true"  # 是否测试请求感知调度的消融实验
TEST_ABLATION_DECODE="false"  # 是否测试解码器调度的消融实验
TEST_ALL="true"  # 是否运行端到端实验
IGNORE="true"  # 是否忽略EOS标记
BASELINE_CSV_PATH="/root/predict-schedule/vllm/examples/online_serving/disaggregated_serving_p2p_nccl_xpyd/experiment_result/experiment_paper/tmp/baseline_119/benchmark_np1000_rr20_mt8192_20260119_155336_2p4d/dataset_result/test_results_20260119_160536.csv"
...
BASE_RESULT_DIR=${BASE_RESULT_DIR:-./experiment_result/experiment_paper/tmp/use_p2d_119}
# Proxy
...
BENCH_REQUEST_RATE_LIST=${BENCH_REQUEST_RATE_LIST:-"20"}
