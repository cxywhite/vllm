...
# 转而遍历该目录下的子目录进行复现测试。
BASELINE_ROOT_DIR="/root/predict-schedule/vllm/examples/online_serving/disaggregated_serving_p2p_nccl_xpyd/experiment_result/experiment_paper/tmp/qwen_baseline_127"
BENCH_DATASET_NAME=${BENCH_DATASET_NAME:-qwen_new}
...
BASE_RESULT_DIR=${BASE_RESULT_DIR:-./experiment_result/experiment_paper/tmp/qwen_ablation_p2d_auto_127_2p4d}
# Proxy
