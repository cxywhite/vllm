...
BENCH_SCRIPT=${BENCH_SCRIPT:-/root/predict-schedule/vllm/benchmarks/benchmark_serving_ablation_decode.py}
...
BASE_RESULT_DIR=${BASE_RESULT_DIR:-./experiment_result/experiment_paper/tmp/qwen_decode_128}

PROXY_PORT=${PROXY_PORT:-21103}
BENCH_PORT=${BENCH_PORT:-21203}

PREFILL_GPUS=${PREFILL_GPUS:-0}
PREFILL_PORTS=${PREFILL_PORTS:-21301}
PREFILL_KV_PORTS=${PREFILL_KV_PORTS:-21411}
...
DECODE_PORTS=${DECODE_PORTS:-21520}
DECODE_KV_PORTS=${DECODE_KV_PORTS:-21632}
...
BENCH_REQUEST_RATE_LIST=${BENCH_REQUEST_RATE_LIST:-"12"}
...
setup_directories() {
    ...
    BENCHMARK_DIR="${BASE_RESULT_DIR}/aimd_benchmark_np${num_prompts}_rr${req_rate}_mt${max_tokens}_${timestamp}_2p4d"
