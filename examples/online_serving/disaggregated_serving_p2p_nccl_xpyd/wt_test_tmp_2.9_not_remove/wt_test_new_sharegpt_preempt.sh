...
IGNORE="true"
REPRODUCE_BASELINE="true"
SAVE_SAMPLE="false"
REPRODUCE_BASELINE_CSV_PATH="/root/predict-schedule/vllm/examples/online_serving/disaggregated_serving_p2p_nccl_xpyd/experiment_result/experiment_paper/tmp/preempt_122/benchmark_np100_rr1_mt8192_20260121_202658_1p1d/dataset_result/test_results_20260121_203947.csv"
...
BASE_RESULT_DIR=${BASE_RESULT_DIR:-./experiment_result/experiment_paper/tmp/preempt_122}
...
DECODE_PORTS=${DECODE_PORTS:-22023}
