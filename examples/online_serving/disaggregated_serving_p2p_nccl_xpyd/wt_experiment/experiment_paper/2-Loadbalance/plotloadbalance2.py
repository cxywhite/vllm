        ...
        for metric in METRICS:
            ...
            for ds_label, ds_dir_key in DATASETS.items():
                ...
                for qps in QPS_LIST:
                    ...
                    avg_rr = get_avg(rr_dirs)
                    avg_opt = get_avg(opt_dirs)
...
def draw_tight_academic_table(df):
    ...
    save_path = os.path.join(save_dir, f"table_three_color_{datetime.now().strftime('%H%M%S')}.png")
