...
async def handle_request():
    try:
        ...
        predictor_meta=Custom_Metadata(req_id=None,token_range=None,num_tokens=None,temperature=None,top_p=None,top_k=None,repetition_penalty=None,predict_output_len=original_request_data['mean_len']).to_dict()
